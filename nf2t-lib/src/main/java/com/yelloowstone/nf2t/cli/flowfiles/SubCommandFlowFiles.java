 ...
 */
@Command(name = "flowfiles", aliases = { "ff" }, versionProvider = App.class, subcommands = { SubCommandUnpackage.class, SubCommandPackage.class, SubCommandGenerateSchema.class,
...
public class SubCommandFlowFiles implements Callable<Integer>, IVersionProvider {
