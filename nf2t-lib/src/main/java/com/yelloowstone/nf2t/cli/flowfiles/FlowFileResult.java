...
public class FlowFileResult {
	...
	@JsonCreator
	public FlowFileResult(@JsonProperty("flowFilePath") final SourceFile flowFilePath,
			@JsonProperty("contentPath") final SourceFile contentPath,
			@JsonProperty("attributes") final Map<String, String> rawAttributeExpressions,
			@JsonProperty("contentSize") final long size) {
