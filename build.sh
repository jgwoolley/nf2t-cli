...
mvn $MVN_ARGS help:evaluate -Dexpression=project.groupId -Doutput=groupId.mvnhelp --quiet
mvn $MVN_ARGS help:evaluate -Dexpression=project.artifactId -Doutput=artifactId.mvnhelp --quiet
mvn $MVN_ARGS help:evaluate -Dexpression=project.version -Doutput=version.mvnhelp --quiet
